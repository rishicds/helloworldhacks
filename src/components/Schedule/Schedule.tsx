...
export default function Schedule() {
  ...
  const scheduleData = {
    day1: [
      ...
      { time: "April 4 10:00AM-5:00PM", event: "Tech Verse ( Multiple Speakers Offline Session making the Participants ready for Industry Exposure )", description: "Offline Session by TBD" },
      ...
      { time: "April 14 12:01AM", event: "Proposal Writing Starts", description: "Learn how to leverage popular APIs by TBD" },
      ...
      { time: "April 21 12:00AM-May 5 12:59PM", event: "Hacking Period", description: "Start your day with energy by TBD" },
      ...
      { time: "April 22-25", event: "Mentor Mentee MatchMaking", description: "Mentors Connection will be matched with the Participants based on Projects Proposal by TBD" },
    ],
    day2: [
      ...
      { time: "April 28-29", event: "Mid Evaluation", description: "Mentors will go through the progress and the development of the Projects and accordingly Evaluate the Current implementation station of the Projects by TBD." },
      ...
      { time: "May 1-5", event: "Documentation Writing Period (Participants will document the Entire Project Development Process and will write articles in Technical Blogs to enhance their Technical Outlook and have a Documentation of their Project.)", description: "Dev.to / Hashnode / Medium by TBD" },
      { time: "May 2", event: "Technical Writing Session", description: "Online Session by TBD" },
      { time: "May 3", event: "Networking and PR Session for Participant's connection development", description: "Online Session by TBD" },
      ...
      { time: "May 12", event: "Pitching Ideas and Prototype in Front of Judges", description: "Offline ( Online for Distant Participants ) by TBD" },
      ...
      <div className="relative">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16 relative">
            {/* Decorative elements */}
            <div className="absolute left-0 top-1/2 w-16 h-16 -translate-y-1/2 hidden md:block">
            ...
            <div className="absolute right-0 top-1/2 w-16 h-16 -translate-y-1/2 hidden md:block">
              <div className="w-full h-full relative">
                <div className="absolute inset-0 bg-[#3DEFE9] opacity-20 rounded-full animate-ping" />
                <div className="absolute inset-2 bg-[#3DEFE9] opacity-30 rounded-full" />
              </div>
            ...
            <div className="flex flex-col md:flex-row items-center justify-center gap-8">
              ...
              <div>
                ...
                <p className="text-xl text-white/70 max-w-3xl">
                  A month of coding, learning, and fun. Plan your <span className="text-[#3DEFE9] font-bold">HelloWorld Hacks</span> adventure.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="relative">
            ...
            <Tabs defaultValue="day1" className="w-full  max-w-6xl mx-auto" onValueChange={setActiveTab}>
              ...
              {Object.entries(scheduleData).map(([day, events]) => (
                <TabsContent key={day} value={day} className="mt-0 block">
